...
(function (root, factory) {
  ...
  _.extend(MomentFormatter.prototype, {
    ...
    /**
       ...
       @cfg {string} [options.modelLang=moment.locale()] The locale the model
       ...
       @cfg {string} [options.displayLang=moment.locale()] The locale the display
       values should be read/written in.
...
///#source 1 1 /core/lib/circle-progress/circle-progress.js
/*
...
///#source 1 1 /core/lib/hammer/hammer.min.js
...
///#source 1 1 /core/lib/jquery-tween/jQueryTween.js
/**
...
///#source 1 1 /core/lib/jquery-tween/RequestAnimationFrame.js
...
///#source 1 1 /core/lib/jquery-tween/tween.min.js
// tween.js v.15 https://github.com/sole/tween.js
...
///#source 1 1 /core/js/controller/framefactory.js
var Wakey;
(function (Wakey) {
...
///#source 1 1 /core/js/view/frame.js
var __extends = this.__extends || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
    __.prototype = b.prototype;
